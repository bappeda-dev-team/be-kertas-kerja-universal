...
func InitializeServer() *http.Server {
	...
	pohonKinerjaOpdServiceImpl := service.NewPohonKinerjaOpdServiceImpl(pohonKinerjaRepositoryImpl, opdRepositoryImpl, pegawaiRepositoryImpl, tujuanOpdRepositoryImpl, crosscuttingOpdRepositoryImpl, reviewRepositoryImpl, db)
	...
	sasaranOpdServiceImpl := service.NewSasaranOpdServiceImpl(sasaranOpdRepositoryImpl, opdRepositoryImpl, rencanaKinerjaRepositoryImpl, manualIKRepositoryImpl, pegawaiRepositoryImpl, pohonKinerjaRepositoryImpl, db)
...
var laporanSet = wire.NewSet(repository.NewLaporanRepositoryImpl, wire.Bind(new(repository.LaporanRepository), new(*repository.LaporanRepositoryImpl)), service.NewLaporanServiceImpl, wire.Bind(new(service.LaporanService), new(*service.LaporanServiceImpl)), controller.NewLaporanControllerImpl, wire.Bind(new(controller.LaporanController), new(*controller.LaporanControllerImpl)))
